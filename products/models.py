...
class BaseModel(models.Model):
    ...
    #to manipulate django to treat it as a class instead of a model
    #use meta class
...
class Product(BaseModel):
    ...
    product_price = models.models.IntegerField(default=0)
...
class ProductMetaInfo(BaseModel):
    ...
    product_unit = models.CharField(max_length=100,null = True, blank=True, choices=(("KG","KG"),("ML","ML"),("L","L"),(None,None)))
